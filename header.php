...
<div id="page" class="site site-wrap">
  ...
  <header class="site-header">
      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-5 site-header__menu__wrap">
            ...
            <button class="site-header__menu-mobile__toggler" type="button" data-toggle="collapse">
                      <span>
    ...
    <nav id="site__menu-mobile" class="site-header__menu-mobile">
      <ul class="site-header__menu-mobile__list">
        <li class="site-header__menu-mobile__item">
  
          <a href="/administration.html"> <img src="../assets/img/nav/clarity_users-outline-badged.svg" alt="">Administration</a></li>
        <li class="site-header__menu-mobile__item">
  
          <a href="/priorities.html"><img src="../assets/img/nav/cil_list-high-priority.svg" alt="/">Priorities</a></li>
        <li class="site-header__menu-mobile__item">
          <a href="/briefing-room.html"><img src="../assets/img/nav/fluent_device-meeting-room-16-regular.svg" alt="">Briefing Room</a></li>
      </ul>
    </nav>
  </header>
  <!--HEADER END-->
